...
class Command(BaseCommand):
    ...
    def _seed_service_categories(self):
        categories = [
            {'name': 'Автоперевозки', 'name_en': 'Road Transportation', 'slug': 'cargo-transportation', 'icon': 'fas fa-truck', 'description': 'Автомобильные грузоперевозки по всей России, СНГ и Китаю', 'description_en': 'Road freight transportation across Russia, CIS, and China', 'order': 1},
            {'name': 'Сборный груз', 'name_en': 'Consolidated Cargo', 'slug': 'consolidated-cargo', 'icon': 'fas fa-boxes', 'description': 'Консолидированные грузоперевозки по выгодным тарифам', 'description_en': 'Consolidated shipping at competitive rates', 'order': 2},
            {'name': 'Доставка в розничные сети', 'name_en': 'Retail Chain Delivery', 'slug': 'retail-chains', 'icon': 'fas fa-store', 'description': 'Доставка товаров в крупнейшие розничные сети', 'description_en': 'Delivery to major retail chains', 'order': 3},
            {'name': 'Доставка на маркетплейсы', 'name_en': 'Marketplace Delivery', 'slug': 'marketplaces', 'icon': 'fas fa-cart-shopping', 'description': 'Доставка на Wildberries, Ozon, Яндекс Маркет и другие', 'description_en': 'Delivery to Wildberries, Ozon, Yandex Market and more', 'order': 4},
            {'name': 'Доставка на стройрынки', 'name_en': 'Construction Market Delivery', 'slug': 'construction-markets', 'icon': 'fas fa-hard-hat', 'description': 'Доставка на строительные рынки и гипермаркеты', 'description_en': 'Delivery to construction stores and hypermarkets', 'order': 5},
            {'name': 'Тариф «Посылка»', 'name_en': 'Parcel Tariff', 'slug': 'posylka-tariff', 'icon': 'fas fa-box', 'description': 'Экономичная доставка небольших посылок', 'description_en': 'Affordable small parcel shipping', 'order': 6},
            {'name': 'Паллетные перевозки', 'name_en': 'Pallet Transportation', 'slug': 'pallet-transportation', 'icon': 'fas fa-pallet', 'description': 'Перевозка грузов на паллетах', 'description_en': 'Palletized cargo shipping', 'order': 7},
            {'name': 'Авиаперевозки', 'name_en': 'Air Cargo', 'slug': 'air-cargo', 'icon': 'fas fa-plane', 'description': 'Быстрая доставка грузов авиатранспортом', 'description_en': 'Express air freight delivery', 'order': 8},
            {'name': 'Контейнерные перевозки', 'name_en': 'Container Shipping', 'slug': 'container', 'icon': 'fas fa-ship', 'description': 'Контейнерные перевозки 20ft, 40ft по всем направлениям', 'description_en': '20ft and 40ft container transportation', 'order': 9},
            {'name': 'FТL (Отдельная машина)', 'name_en': 'FTL (Full Truck Load)', 'slug': 'ftl', 'icon': 'fas fa-truck-moving', 'description': 'Выделенный транспорт для вашего груза', 'description_en': 'Dedicated transport for your cargo', 'order': 10},
            {'name': 'Доставка документов', 'name_en': 'Document Delivery', 'slug': 'document-delivery', 'icon': 'fas fa-envelope', 'description': 'Экспресс-доставка документов по России', 'description_en': 'Express document delivery across Russia', 'order': 11},
            {'name': 'Виды транспорта', 'name_en': 'Transport Types', 'slug': 'transport-types', 'icon': 'fas fa-route', 'description': 'Все виды транспорта: авто, ЖД, авиа, море, мультимодальные', 'description_en': 'All transport types: road, rail, air, sea, multimodal', 'order': 12},
        ]
    ...
    def _seed_services(self):
        ...
        services_data = [
            ...
            {'cat': 'cargo-transportation', 'name': 'Междугородние перевозки', 'name_en': 'Intercity Shipping', 'slug': 'intercity', 'desc': 'Грузоперевозки между городами России', 'short': 'от 25 ₽/кг', 'icon': 'fas fa-truck', 'price': Decimal('25.00'), 'unit': '₽/кг', 'order': 1},
            {'cat': 'cargo-transportation', 'name': 'Международные перевозки', 'name_en': 'International Shipping', 'slug': 'international', 'desc': 'Грузоперевозки в СНГ и Китай', 'short': 'от 45 ₽/кг', 'icon': 'fas fa-globe', 'price': Decimal('45.00'), 'unit': '₽/кг', 'order': 2},
            {'cat': 'cargo-transportation', 'name': 'Перевозка негабаритных грузов', 'name_en': 'Oversized Cargo', 'slug': 'oversized', 'desc': 'Транспортировка крупногабаритных грузов', 'short': 'индивидуальный расчет', 'icon': 'fas fa-expand', 'price': None, 'unit': '', 'order': 3},
            # Consolidated Cargo
            {'cat': 'consolidated-cargo', 'name': 'Сборные грузы по России', 'name_en': 'Consolidated Cargo Russia', 'slug': 'consolidated-russia', 'desc': 'Консолидация грузов от разных отправителей', 'short': 'от 18 ₽/кг', 'icon': 'fas fa-boxes', 'price': Decimal('18.00'), 'unit': '₽/кг', 'order': 1},
            {'cat': 'consolidated-cargo', 'name': 'Сборные грузы из Китая', 'name_en': 'Consolidated Cargo from China', 'slug': 'consolidated-china', 'desc': 'Консолидированные поставки из Китая', 'short': 'от 35 ₽/кг', 'icon': 'fas fa-shipping-fast', 'price': Decimal('35.00'), 'unit': '₽/кг', 'order': 2},
            # Retail Chains
            {'cat': 'retail-chains', 'name': 'Доставка в Пятёрочку', 'name_en': 'Delivery to Pyaterochka', 'slug': 'pyaterochka', 'desc': 'Доставка в сеть магазинов Пятёрочка', 'short': 'индивидуальный тариф', 'icon': 'fas fa-store', 'price': None, 'unit': '', 'order': 1},
            {'cat': 'retail-chains', 'name': 'Доставка в Магнит', 'name_en': 'Delivery to Magnit', 'slug': 'magnit', 'desc': 'Доставка в сеть магазинов Магнит', 'short': 'индивидуальный тариф', 'icon': 'fas fa-warehouse', 'price': None, 'unit': '', 'order': 2},
            {'cat': 'retail-chains', 'name': 'Доставка в Ленту', 'name_en': 'Delivery to Lenta', 'slug': 'lenta', 'desc': 'Доставка в гипермаркеты Лента', 'short': 'индивидуальный тариф', 'icon': 'fas fa-warehouse', 'price': None, 'unit': '', 'order': 3},
            # Marketplaces
            {'cat': 'marketplaces', 'name': 'Доставка на Wildberries', 'name_en': 'Delivery to Wildberries', 'slug': 'wb', 'desc': 'Полный цикл доставки на склад Wildberries', 'short': 'от 22 ₽/кг', 'icon': 'fas fa-cart-shopping', 'price': Decimal('22.00'), 'unit': '₽/кг', 'order': 1},
            {'cat': 'marketplaces', 'name': 'Доставка на Ozon', 'name_en': 'Delivery to Ozon', 'slug': 'ozon', 'desc': 'Доставка на склады Ozon', 'short': 'от 22 ₽/кг', 'icon': 'fas fa-cart-shopping', 'price': Decimal('22.00'), 'unit': '₽/кг', 'order': 2},
            {'cat': 'marketplaces', 'name': 'Доставка на Яндекс Маркет', 'name_en': 'Delivery to Yandex Market', 'slug': 'yandex-market', 'desc': 'Доставка на склады Яндекс Маркета', 'short': 'от 20 ₽/кг', 'icon': 'fas fa-cart-shopping', 'price': Decimal('20.00'), 'unit': '₽/кг', 'order': 3},
            # Construction Markets
            {'cat': 'construction-markets', 'name': 'Доставка в Leroy Merlin', 'name_en': 'Delivery to Leroy Merlin', 'slug': 'leroy-merlin', 'desc': 'Доставка товаров в гипермаркеты Леруа Мерлен', 'short': 'индивидуальный расчет', 'icon': 'fas fa-hard-hat', 'price': None, 'unit': '', 'order': 1},
            {'cat': 'construction-markets', 'name': 'Доставка стройматериалов', 'name_en': 'Construction Materials Delivery', 'slug': 'construction-materials', 'desc': 'Перевозка строительных материалов и оборудования', 'short': 'от 30 ₽/кг', 'icon': 'fas fa-screwdriver-wrench', 'price': Decimal('30.00'), 'unit': '₽/кг', 'order': 2},
            # Posylka Tariff
            {'cat': 'posylka-tariff', 'name': 'Посылка до 5 кг', 'name_en': 'Parcel up to 5 kg', 'slug': 'parcel-5kg', 'desc': 'Экономичная доставка посылок до 5 кг', 'short': 'от 350 ₽', 'icon': 'fas fa-box', 'price': Decimal('350.00'), 'unit': '₽', 'order': 1},
            {'cat': 'posylka-tariff', 'name': 'Посылка до 10 кг', 'name_en': 'Parcel up to 10 kg', 'slug': 'parcel-10kg', 'desc': 'Экономичная доставка посылок до 10 кг', 'short': 'от 550 ₽', 'icon': 'fas fa-box-open', 'price': Decimal('550.00'), 'unit': '₽', 'order': 2},
            {'cat': 'posylka-tariff', 'name': 'Посылка до 20 кг', 'name_en': 'Parcel up to 20 kg', 'slug': 'parcel-20kg', 'desc': 'Экономичная доставка посылок до 20 кг', 'short': 'от 850 ₽', 'icon': 'fas fa-boxes', 'price': Decimal('850.00'), 'unit': '₽', 'order': 3},
            # Pallet Transportation
            {'cat': 'pallet-transportation', 'name': 'Паллетный борт', 'name_en': 'Pallet Flatbed', 'slug': 'pallet-flatbed', 'desc': 'Перевозка грузов на паллетах', 'short': 'от 200 ₽/паллета', 'icon': 'fas fa-pallet', 'price': Decimal('200.00'), 'unit': '₽/паллета', 'order': 1},
            # Air Cargo
            {'cat': 'air-cargo', 'name': 'Авиадоставка по России', 'name_en': 'Air Delivery Russia', 'slug': 'air-russia', 'desc': 'Срочная авиадоставка по России', 'short': 'от 150 ₽/кг', 'icon': 'fas fa-plane', 'price': Decimal('150.00'), 'unit': '₽/кг', 'order': 1},
            {'cat': 'air-cargo', 'name': 'Авиадоставка международная', 'name_en': 'International Air Delivery', 'slug': 'air-international', 'desc': 'Международная авиадоставка', 'short': 'от 350 ₽/кг', 'icon': 'fas fa-plane-departure', 'price': Decimal('350.00'), 'unit': '₽/кг', 'order': 2},
            # Container
            {'cat': 'container', 'name': '20ft контейнер', 'name_en': '20ft Container', 'slug': 'container-20ft', 'desc': 'Перевозка в 20-футовых контейнерах', 'short': 'от 150 000 ₽', 'icon': 'fas fa-ship', 'price': Decimal('150000.00'), 'unit': '₽', 'order': 1},
            {'cat': 'container', 'name': '40ft контейнер', 'name_en': '40ft Container', 'slug': 'container-40ft', 'desc': 'Перевозка в 40-футовых контейнерах', 'short': 'от 250 000 ₽', 'icon': 'fas fa-ship', 'price': Decimal('250000.00'), 'unit': '₽', 'order': 2},
            # FTL
            {'cat': 'ftl', 'name': 'Фургон 20т', 'name_en': 'Truck 20t', 'slug': 'ftl-20t', 'desc': 'Выделенная фура 20 тонн', 'short': 'от 80 000 ₽', 'icon': 'fas fa-truck-moving', 'price': Decimal('80000.00'), 'unit': '₽', 'order': 1},
            {'cat': 'ftl', 'name': 'Фургон 10т', 'name_en': 'Truck 10t', 'slug': 'ftl-10t', 'desc': 'Выделенная фура 10 тонн', 'short': 'от 50 000 ₽', 'icon': 'fas fa-truck-moving', 'price': Decimal('50000.00'), 'unit': '₽', 'order': 2},
            {'cat': 'ftl', 'name': 'Рефрижератор', 'name_en': 'Refrigerated Truck', 'slug': 'ftl-refrigerator', 'desc': 'Рефрижератор с температурным режимом', 'short': 'от 100 000 ₽', 'icon': 'fas fa-snowflake', 'price': Decimal('100000.00'), 'unit': '₽', 'order': 3},
            # Document Delivery
            {'cat': 'document-delivery', 'name': 'Экспресс-доставка документов', 'name_en': 'Express Document Delivery', 'slug': 'express-docs', 'desc': 'Срочная доставка документов по городу и между городами', 'short': 'от 500 ₽', 'icon': 'fas fa-envelope', 'price': Decimal('500.00'), 'unit': '₽', 'order': 1},
            # Transport Types
            {'cat': 'transport-types', 'name': 'Автомобильные перевозки', 'name_en': 'Road Transport', 'slug': 'road-transport', 'desc': 'Перевозки автотранспортом', 'short': 'от 25 ₽/кг', 'icon': 'fas fa-truck', 'price': None, 'unit': '', 'order': 1},
            {'cat': 'transport-types', 'name': 'Грузовой автотранспорт', 'name_en': 'Truck Transport', 'slug': 'truck-transport', 'desc': 'Перевозки грузовым автотранспортом', 'short': 'от 25 ₽/кг', 'icon': 'fas fa-truck', 'price': Decimal('100.00'), 'unit': '₽/кг', 'order': 2},
            {'cat': 'transport-types', 'name': 'Железнодорожные перевозки', 'name_en': 'Rail Transport', 'slug': 'rail-transport', 'desc': 'Перевозки по железной дороге', 'short': 'от 10 ₽/кг', 'icon': 'fas fa-train', 'price': Decimal('10.00'), 'unit': '₽/кг', 'order': 3},
            {'cat': 'transport-types', 'name': 'Авиаперевозки', 'name_en': 'Air Transport', 'slug': 'air-transport', 'desc': 'Перевозки авиатранспортом', 'short': 'от 150 ₽/кг', 'icon': 'fas fa-plane', 'price': Decimal('200.00'), 'unit': '₽/кг', 'order': 4},
            {'cat': 'transport-types', 'name': 'Мультимодальные перевозки', 'name_en': 'Multimodal Transport', 'slug': 'multimodal', 'desc': 'Комбинированные перевозки разными видами транспорта', 'short': 'от 30 ₽/кг', 'icon': 'fas fa-route', 'price': Decimal('30.00'), 'unit': '₽/кг', 'order': 5},
        ]
